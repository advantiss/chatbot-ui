...
<img src="./public/readme/screenshot.png" alt="Prozorro AI Agent" width="600">
...
Now, open a terminal in the root directory of your local Prozorro AI Agent repository. We will execute a few commands here.
...
In the setup page, import your GitHub repository for your hosted instance of Prozorro AI Agent. Within the project Settings, in the "Build & Development Settings" section, switch Framework Preset to "Next.js".
...
Once deployed, you should be able to use your hosted instance of Prozorro AI Agent via the URL Vercel gives you.
